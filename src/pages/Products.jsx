...
//   }, [products, searchTerm, sortBy, selectedCategory]); // 🆕 include selectedCategory
...
//     // ✅ FIX: Sorting direction (ensure "Newest First" actually shows latest first)
//     if (sortBy === 'price-low') {
...
//     if (addingToCartId === product._id) return;
...
//   <div key={product._id} ref={el => (productRefs.current[product._id] = el)}>
//     {/* <ProductCard
//       item={product}
