...
//       <Star
//         key={i}
//         className={`w-4 h-4 ${value >= i ? "text-yellow-400" : "text-gray-300"}`}
//       />
//     ))}
//   </div>
// );
...
//     service.discount > 0
//       ? +(service.price * (1 - Number(service.discount) / 100)).toFixed(2)
//       : service.price;
...
//       if (filter === "very-positive") return star === 5;
//       if (filter === "positive")  return star === 4 || star < 3 || star === 2 || star === 1; // negative are mapped as positive
//       if (filter === "average") return star === 3;
//       return true;
//     });
//   }

//   // Sorted reviews — most recent first
//   const sortedReviews = [...reviews].sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));

//   // Filtered set for the active tab
//   const filteredReviews = filterReviews(sortedReviews, reviewFilter);

//   // Show only top 5 if not expanded
...
//         className="flex items-center gap-2 text-gray-700 hover:text-pink-600 font-medium mb-4"
//       >
//         <ArrowLeft className="w-4 h-4" />
//         Back to Services
//       </button>

//       {/* 🖼️ Image + Details Card */}
...
//             }}
//           />
//           <div className="absolute bottom-3 right-3 bg-white/90 px-3 py-1 rounded-lg shadow text-pink-600 font-semibold">
//             ₹{formatPrice(discountedPrice)}
//             {service.discount > 0 && (
//               <span className="text-gray-400 text-sm ml-1 line-through">
...
//             <button
//               onClick={() =>
//                 isAuthenticated ? setBookingOpen(true) : setAuthModalOpen(true)
//               }
//               className="flex-1 px-4 py-3 bg-gradient-to-r from-pink-600 to-rose-600 text-white rounded-lg font-semibold shadow hover:scale-[1.02] transition"
//             >
//               Book Appointment
//             </button>
//             <button
...
//               }
//               className="flex-1 px-4 py-3 border border-gray-200 bg-white rounded-lg font-semibold text-gray-700 hover:bg-gray-50"
//             >
//               Read Reviews
//             </button>
//           </div>
...
//       {/* 🧾 Reviews Section */}
//       <div className="bg-white rounded-2xl p-3 shadow-md border border-gray-100 space-y-4">
//         <h3 className="text-lg font-semibold text-gray-900 mb-2">
//           Customer Reviews
//         </h3>

//         {/* Review Filter Tabs (mobile first) */}
...
//                 setShowAllReviews(false); // always reset to top 5
//               }}
...
//             No reviews yet for this filter. Be the first to review!
//           </p>
//         ) : (
//           <>
...
//                 <button
//                   className="px-5 py-2 rounded text-pink-600 font-semibold border bg-white shadow hover:bg-pink-600 hover:text-white transition"
//                   onClick={() => setShowAllReviews((val) => !val)}
//                 >
...
//                 rows={4}
//                 className="w-full mt-2 px-3 py-2 border border-gray-200 rounded focus:outline-none"
...
//                   className="px-4 py-2 bg-gradient-to-r from-pink-600 to-rose-600 text-white rounded font-semibold disabled:opacity-60"
//                 >
